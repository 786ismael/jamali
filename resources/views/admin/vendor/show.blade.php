		...
		<div class="driver-details">
			...
			<div class="top-details">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<div class="profile-details">
							...
							<div class="txt-details">
								<ul>
						<form class="form" id="update-form" action="{{url('admin/vendor/update',$data['user']->id)}}" method="post" enctype="multipart/form-data">
							@csrf
							@method('put')
							...
							<div class="btn-wrapper">
								...
								<a href="{{route('admin/vendor/show',$data['user']->id)}}" class="same-btn1 btn-cancel">Cancel</a>
							</div>
						</form>
								</ul>
							</div>
				...
				<div class="modal" tabindex="-1" id="deleteModal" role="dialog">
				    <form class="form" action="{{route('admin/vendor/destroy',$data['user']->id)}}" method="POST">
					   @csrf
					   @method('DELETE')
