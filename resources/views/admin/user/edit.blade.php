	...
	<div class="main-body">
		<div class="inner-body">
			<div class="add-driver clear-col">
				...
				@endif
				<form method="POST" enctype="multipart/form-data" action="{{ route('admin/driver/update',$data['user']->id) }}">
					@csrf
					{{ method_field('PUT') }}
						...
						<div class="row">
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="form-group">
									<label>Name:</label>
									<input type="text" placeholder="Name" class="form-control" name="name" value="{{$data['user']->name}}">
									@error('name')
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="form-group">
									<label>Email:</label>
									<input type="email" placeholder="Email" class="form-control" name="email" value="{{$data['user']->email}}" readonly="">
									@error('email')
										<span class="invalid-feedback" role="alert">
											<strong style="color: red">{{ $message }}</strong>
										</span>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="form-group">
									...
									<input type="text" placeholder="Mobile No." class="form-control" name="mobile" value="{{$data['user']->mobile}}"readonly="">
									@error('mobile')
										<span class="invalid-feedback" role="alert">
											<strong style="color: red">{{ $message }}</strong>
										</span>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="form-group">
									...
									<input type="text" placeholder="Emegency No." class="form-control" name="emergency_mobile" value="{{$data['user']->emergency_mobile}}" readonly="">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="form-group">
									...
									<img src="{{$data['user']->profile_image}}" id="show-image-1" width="70"  height="70">
									@error('profile_image')
										<span class="invalid-feedback" role="alert">
										<strong style="color: red">{{ $message }}</strong>
										</span>
									...
									<select class="form-control" name="city">
										...
										@else
											@foreach($data['cities'] as $key => $value)
												<option value="{{$value->city_id}}" @if($data['user']->city_id==$value->city_id){{'selected'}}@endif>{{$value->name}}</option>	
											@endforeach
										@endif
									</select>
									@error('city')
							...
							{{-- <div class="col-md-6 col-sm-6 col-xs-12">
								<div class="form-group">
									...
									<img src="{{$data['user']->documents[0]->document}}" id="show-image-2" width="100"  height="70">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="form-group">
									...
									<img src="{{$data['user']->documents[1]->document}}" id="show-image-3" width="100"  height="70">
