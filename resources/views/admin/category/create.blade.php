						...
						<div class="row">
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="form-group">
									...
									<input type="text" placeholder="Category Name" class="form-control" name="category_name" value="{{old('category_name')}}">
									@error('category_name')
								...
								<div class="form-group">
									...
									<input type="text" placeholder="Category Name Ar" class="form-control" name="category_name_ar" value="{{old('category_name_ar')}}">
