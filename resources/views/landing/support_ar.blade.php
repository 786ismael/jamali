...
<body>
	...
	<section class="term_condition form-support">
	  	<div class="container">
	  		<h3 class="section-heading">الدعم</h3>
	  		<div class="fs-inner">
	  			<form>
	  				<h2 class="text-center">أرسل طلب دعم!</h2>
			        <div class="row">
						<div class="col-sm-6">
							<input type="text" class="form-control" id="" placeholder="الاسم الاول"  required>
						</div>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="" placeholder="الكنية" required>
						</div>
						<div class="col-sm-6">
							<input type="email" class="form-control" id="" placeholder="البريد الإلكتروني"  required>
						</div>
						<div class="col-sm-6">
							<input type="number" class="form-control" id="" placeholder="رقم الهاتف"  required>
						</div>
						<div class="col-sm-12">
							<textarea class="form-control" rows="5" id="" placeholder="رسالة"></textarea>
						</div>

						<div class="col-sm-12">
							<div class="text-center">
								<button class="btn btn-primary support-btn" type="submit">إرسال</button>
							</div>
						</div>
			        </div>
	        	</form>
