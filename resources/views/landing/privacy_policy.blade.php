	...
	<section class="term_condition">
		<div class="container">
			<div class="body">
                ...
                <h1>Privacy Policy of Jamali</h1>
                <p>In order to receive information about your Personal Data, the purposes and the parties the Data is shared with, contact the Owner <a href="{{asset('public/landing')}}/mailto:Jamali_support@almotelq.com">Jamali_support@almotelq.com</a></p>
